...
/* Module structure */
static struct PyModuleDef emojimodule = {
    PyModuleDef_HEAD_INIT,
    "emoji",                                       /* name of module */
    "encode and decode emoji to hex module",       /* Doc string (may be NULL) */
    -1,                                            /* Size of per-interpreter state or -1 */
    EmojiMethods                                   /* Method table */
};

/* Module initialization function */
PyMODINIT_FUNC PyInit_emoji(void) {
  return PyModule_Create(&emojimodule);
}
